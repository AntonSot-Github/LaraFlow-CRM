...
Route::middleware(['auth', 'role:admin'])->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        //Show task page
        Route::get('/clients/{client}/deals/{deal}/tasks', [TaskController::class, 'show'])->name('tasks.show');

        //Save task
        Route::post('/clients/{client}/deals/{deal}/tasks', [TaskController::class, 'store'])->name('task.store');
